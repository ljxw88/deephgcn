...
def load_data(args, datapath, normalize_feats = True):
    args.use_feats = True
    ...
    return data['adj_train_norm'], data['features'], data['labels'], data['idx_train'], data['idx_val'], data['idx_test']
