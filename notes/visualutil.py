...
def add_geodesic_grid(ax: plt.Axes, manifold: geoopt.Stereographic, line_width=0.1, COLOR = "gray"):
    ...
    def plot_geodesic(gv):
        ax.plot(*gv.t().numpy(), STYLE, color=COLOR, linewidth=LINE_WIDTH, zorder = -1)
